...
/*
 * Velikost pisave dnevne evidence je enaka za vse mesece.
 * Te vrednosti ohranjajo trenutno velikost, ki je bila uporabljena
...
type PDFProps = {
  workOrdersOverride?: WorkOrder[];
  userNameOverride?: string;
  selectedMonthOverride?: string;
  autoExport?: boolean;
...
function PDF({
  ...
  const contextWorkOrders = useWorkOrders().workOrders;
  const workOrders = workOrdersOverride ?? contextWorkOrders;

  const [userName, setUserName] = useState(
    userNameOverride ?? "Uporabnik"
  );
                ...
                <table
                  style={{
                    ...
                    tableLayout:
                      "fixed",
                    fontSize:
                      DAILY_EVIDENCE_TABLE_FONT_SIZE,
                  }}
                >
                  <thead>
                    <tr
