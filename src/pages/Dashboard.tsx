...
import { calculateUniqueWorkHours } from "../utils/workHours";
...
function Dashboard() {
  ...
  const handleEditWorkOrder = (
    ...
    const sameDayOrders = workOrders
      .filter((item) => item.date === workOrder.date)
      .sort((a, b) => b.id - a.id);

    setEditingWorkOrder(workOrder);
    setEditingWorkOrders(sameDayOrders);
  };
  ...
  const handleUpdateWorkOrder = (
    ...
    void updateWorkOrder(workOrder);
    setEditingWorkOrder(null);
    setEditingWorkOrders([]);
  };

  const handleUpdateWorkOrders = async (
