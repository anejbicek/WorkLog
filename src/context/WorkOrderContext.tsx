...
function fromDatabase(
  ...
  return {
    ...
    overtimeNormalHours:
      Number(row.overtime_normal_hours ?? 0),

    overtimeSpecialHours:
      Number(row.overtime_special_hours ?? 0),
...
function toDatabase(
  ...
  return {
    ...
    overtime_normal_hours:
      workOrder.overtimeNormalHours ?? 0,

    overtime_special_hours:
      workOrder.overtimeSpecialHours ?? 0,
